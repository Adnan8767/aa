...
function startGame() {
    myGamePiece = new component(70, 70, "witch2.png", 10, 120, "gif");
    myBackground = new component(500, 400, "bg3.jpg", 0, 0, "gif");
    myScore = new component1("30px", "30px", "white", 0, 40, "text");
